...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/event'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'chari645e70e3d0330'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'chari645e70e3d0330@ssl'); // your store password.
}
